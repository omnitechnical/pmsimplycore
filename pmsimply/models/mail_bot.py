	...
	def _get_answer(self, record, body, values, command=False):
		...
		if self._is_bot_in_private_channel(record):
			...
			if odoobot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
				...
				return _("Wow you are a natural!<br/>Ping someone to grab its attention with @nameoftheuser. <b>Try to ping me using @PMSimplyBot</b> in a sentence.")
			elif odoobot_state == 'onboarding_ping' and self._is_bot_pinged(values):
				self.env.user.odoobot_state = "idle"
				return _("Yep, I am here! 🎉 <br/>You finished the tour, you can <b>close this chat window</b>. Enjoy discovering PMSimply.")
			...
			# easter eggs
				...
				if odoobot_state == 'onboarding_emoji':
					...
					return _("Sorry, I am not listening. To get someone's attention, <b>ping him</b>. Write \"@PMSimplyBot\" and select me.")
